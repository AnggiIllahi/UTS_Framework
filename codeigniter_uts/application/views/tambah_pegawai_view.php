				...
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
					...
					<?php echo form_open_multipart('pegawai/create'); ?>
								...
								<tr>
									...
									<span class="input-group-addon" id="basic-addon3">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Keterangan &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</span>
									<input type="text" class="form-control" id="keterangan" name="keterangan" placeholder="Masukkan keterangan" aria-describedby="basic-addon3">
									</td>
								</tr>
