				...
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
					...
					<?php echo form_open_multipart('jabatan/create/'.$this->uri->segment(3)); ?>
								...
								<tr>
									...
									<input type="text" class="form-control" id="jabatan" name="jabatan" placeholder="Masukkan Jabatan" aria-describedby="basic-addon3">
									</td>
								</tr>
								...
								<tr>
									...
									<input type="date" format="dd/mm/yyyy" placeholder="Masukkan Tanggal Lahir" class="form-control" id="tanggalmulai" name="tanggalMulai" aria-describedby="basic-addon3">
									</td>
								</tr>
								...
								<tr>
									...
									<input type="date" format="dd/mm/yyyy" placeholder="Masukkan Tanggal Lahir" class="form-control" id="tanggalSelesai" name="tanggalSelesai" aria-describedby="basic-addon3">
									</td>
								</tr>
